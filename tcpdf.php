 ...
 * @description This is a PHP class for generating PDF documents without requiring external extensions.
 *
 * NOTES:
 ...
 *
 * - The TCPDF project was forked into WarnockPDF by William Desportes in 2021.
 *
 * Main features:
 ...
 *  * supports JPEG, PNG and SVG images natively, all images supported by GD (GD, GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM) and all images supported via ImageMagick (https://imagemagick.org/script/formats.php)
...
class TCPDF {
	...
	/**
	 * Throw an exception or print an error message and die if the K_TCPDF_THROW_EXCEPTION_ERROR constant is set to true.
